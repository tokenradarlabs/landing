...
export const GetInTouch = () => {
  ...
  return (
    <section id="contact" className="bg-gradient-to-b from-rose-50 to-slate-50 dark:from-gray-800 dark:to-gray-900 py-12 md:py-20 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          <div className="inline-block mb-3 px-4 py-1 bg-purple-100 dark:bg-purple-900/30 rounded-full">
            <p className="text-sm font-medium text-purple-600 dark:text-purple-300">24/7 Support</p>
          </div>
        ...
        <div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          <CustomCard className="bg-gradient-to-br from-white to-rose-50/50 dark:from-gray-800/80 dark:to-gray-900/80 backdrop-blur-sm p-6 md:p-8 h-full flex flex-col shadow-lg border border-rose-100/50 dark:border-gray-700/50 hover:shadow-xl transition-all duration-300">
            ...
            <div className="mt-3 inline-flex space-x-1">
              ...
              <span className="text-sm text-green-600 dark:text-green-400 font-medium">Online now</span>
            </div>
            ...
            <div className="mt-8 space-y-6">
              <div className="flex items-start group">
                ...
                <div className="ml-4">
                  ...
                  <a href="mailto:contact@tokenradar.xyz" className="text-base text-blue-600 dark:text-blue-400 hover:underline">
              ...
              <div className="flex items-start group">
                ...
                <div className="ml-4">
                  ...
                  <a href="https://tokenradar.xyz" target="_blank" rel="noopener noreferrer" className="text-base text-blue-600 dark:text-blue-400 hover:underline">
                    tokenradar.xyz
                  </a>
                </div>
              </div>
            ...
            <div className="mt-10 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="text-gray-400 hover:text-blue-600 dark:hover:text-blue-500">
                ...
                <a href="#" className="text-gray-400 hover:text-blue-700 dark:hover:text-blue-500">
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-6 flex-1 flex flex-col justify-between">
              ...
              <div className="mt-auto pt-6">
                ...
                <p className="mt-3 text-xs text-center text-gray-500 dark:text-gray-400">
                  By submitting this form, you agree to our <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Privacy Policy</a>
                </p>
              </div>
            </form>
          </CustomCard>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 md:p-8 relative overflow-hidden shadow-lg">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0">
              <h3 className="text-xl md:text-2xl font-bold text-white">Need urgent support?</h3>
