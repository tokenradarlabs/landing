  ...
  return (
    <section className="flex flex-col items-center justify-center py-16 px-4 text-center max-w-7xl mx-auto">
      ...
      <div className="mb-8 flex items-center justify-center">
        <div className="w-14 h-14 mr-3 bg-blue-500 rounded-2xl flex items-center justify-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-16 font-sans">
        <CustomButton 
          className="bg-gradient-to-r from-blue-400 to-blue-600 hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-400 text-white px-8 py-6 rounded-lg flex items-center transition-all duration-300"
